'use strict';
const { Collection, messageLink } = require('../../Publish02/index');
const { DiscordSnowflake } = require('../../Package/sapphire/snowflake/index');
const { InteractionType, ChannelType, MessageType, MessageFlags, PermissionFlagsBits, } = require('../../Publish02/api');
