...
class Formatters extends null {
  ...
  static spoiler = deprecate(
    spoiler,
    'Formatters.spoiler() không được dùng nữa. Nhập phương thức này trực tiếp từ discord.js để thay thế.',
  );
  ...
  static strikethrough = deprecate(
    strikethrough,
    'Formatters.strikethrough() không được dùng nữa. Nhập phương thức này trực tiếp từ discord.js để thay thế.',
  );
  ...
  static time = deprecate(
    time,
    'Formatters.time() không được dùng nữa. Nhập phương thức này trực tiếp từ discord.js để thay th.',
  );
  ...
  static underscore = deprecate(
    underscore,
    'Formatters.underscore() không được dùng nữa. Nhập phương thức này trực tiếp từ discord.js để thay thế.',
  );
   ...
   * @deprecated Import this method directly from discord.js instead.
   */
  static userMention = deprecate( userMention, 'Formatters.userMention() không được dùng nữa. Nhập phương thức này trực tiếp từ discord.js để thay thế.');
}
