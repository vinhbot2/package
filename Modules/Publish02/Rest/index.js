...
var require_package = __commonJS({
  "package.json"(exports, module2) {
    ...
    name: "blackcat-club",
    version: "1.3.7",
    description: "sử dụng bot discord v14 cực kỳ đơn giản với BlackCat-club",
    main: "BlackCat.js",
    dependencies: {
    ...
    repository: {
       "type": "git",
       "url": "git+https://github.com/VinhBot/BlackCat-Package.git"
    },
    keywords: [
       "blackcat-club",
       "blackcat music",
    ...
    license: "ISC",
    bugs: {
       url: "https://github.com/VinhBot/BlackCat-Package/issues"
    },
    homepage: "https://github.com/VinhBot/BlackCat-Package#readme"
    };
  }
});
// src/index.ts
...
var import_collection = require("../Collection/collection.cjs");
var import_snowflake = require("../../Package/sapphire/snowflake/index");
var import_undici4 = require("undici");

// src/lib/handlers/SequentialHandler.ts
var import_node_timers = require("timers");
var import_promises = require("timers/promises");
var import_async_queue = require("../../Package/sapphire/async-queue/index");
...
var RequestManager = class extends import_node_events.EventEmitter {
  ...
  setupSweepers() {
    const validateMaxInterval = /* @__PURE__ */ __name((interval) => {
      if (interval > 144e5) {
        throw new Error("Không thể đặt khoảng thời gian lớn hơn 4 giờ");
      }
    }, "validateMaxInterval");
  ...
  async resolveRequest(request2) {
    ...
    if (request2.auth !== false) {
      if (!this.#token) {
        throw new Error("Mã thông báo dự kiến ​​ sẽ được đặt cho yêu cầu này, nhưng không có mã thông báo nào hiện diện");
      }
