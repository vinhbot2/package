...
const { MessageFlags } = require('../../Publish02/api');
...
class MessagePayload {
  ...
  resolveBody() {
    ...
    let allowedMentions =
      typeof this.options.allowedMentions === 'undefined' ? this.target.client.options.allowedMentions : this.options.allowedMentions;
    ...
    this.body = {
      ...
      sticker_ids: this.options.stickers?.map(sticker => sticker.id ?? sticker), thread_name: threadName,
    };
    return this;
  }
